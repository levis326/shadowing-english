...
class PadPortraitPlayerScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PadPortraitPlayerScreen> createState() =>
      _PadPortraitPlayerScreenState();
}

class _PadPortraitPlayerScreenState
    extends ConsumerState<PadPortraitPlayerScreen> {
  ...
  void _applyPlaybackMode() {
    PlayerSystemMediaControls.updatePlaybackState(
  ...
  Widget build(BuildContext context) {
    ...
    final bool compactPlayer = screenWidth < 700;
    final double playerHorizontalPadding = compactPlayer ? 2 : 14;
    ...
    final bool canGenerateAiSubtitles =
        (_videoAsset?.isNotEmpty ?? false) && !state.hasLines;
    ...
    return PadScaffold(
      ...
      useBottomTabWhenPortrait: false,
      ...
      body: AppLoadingOverlay(
        ...
        child: Column(
          children: <Widget>[
            Expanded(
              child: Padding(
                padding: EdgeInsets.fromLTRB(0, compactPlayer ? 4 : 12, 0, 12),
                child: Column(
                  children: <Widget>[
                    Padding(
                    ...
                    SizedBox(height: compactPlayer ? 6 : 10),
                    Expanded(
                      child: Padding(
